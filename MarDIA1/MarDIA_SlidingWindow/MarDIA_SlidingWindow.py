...
def main(
    ...
    df_ms1, df_ms2 = convert_experiment_to_dataframe(
        experiment=exp,
    ...
    plot_dataframe_head(sorted_df_ms1, 300)
    plot_dataframe_head(sorted_df_ms2, 300)
    ...
    print("Correlation results before filtering:")
    plot_dataframe_head(df_result_correlation, 300)
    plot_dataframe_head(df_result_correlation, 100000000)
    ...
    print("Correlation results after filtering:")
    plot_dataframe_head(df_result_correlation, 300)
    plot_dataframe_head(df_result_correlation, 10000000)
